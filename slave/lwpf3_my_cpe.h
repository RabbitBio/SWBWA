...
#define LWPF_KERNELS K(l_worker1_1) K(l_mem_chain) K(l_collect_intv) K(l_collect_1) K(l_my_smem1) K(l_smem1a_forward) K(l_smem1a_backward) K(l_collect_2) K(l_my_smem2) K(l_my_seed_stra) K(l_my_extend1) K(l_my_extend2) K(l_my_extend3) K(l_my_extend4) K(l_my_extend5) K(l_my_extend6) K(l_collect_3) K(l_collect_4) K(l_my_cal_rep) K(l_my_btree_chain) K(l_my_btree_sa) K(l_my_btree_rid) K(l_my_btree_find) K(l_my_btree_merge) K(l_my_btree_add) K(l_my_btree_free) K(l_mem_chain_flt) K(l_mem_flt_chained_seeds) K(l_mem_chain2aln) K(l_mem_sort_dedup_patch1) K(l_worker1_2) K(l_worker2) K(l_2_pre) K(l_2_mem) K(l_2_after) K(l_2_after_1)  K(l_2_after_2) K(l_2_after_3) K(l_2_mem_1) K(l_2_mem_2) K(l_2_mem_3) K(l_2_mem_4) K(l_2_mem_5) K(l_mem_gen_alt) K(l_mem_reg2aln) K(l_mem_matesw1) K(l_mem_matesw2) K(l_bns_fetch_seq) K(l_mem_sort_dedup_patch) K(l_ksw_1) K(l_ksw_2) K(l_ksw_3) K(l_ksw_4) K(l_sort_1) K(l_sort_2) K(l_ksw_global2) K(l_bwa_gen_cigar2) 
